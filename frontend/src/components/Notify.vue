...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="NotifyId" v-model="value.notifyId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            NotifyId :  {{value.notifyId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="FromPhoneNumber" v-model="value.fromPhoneNumber"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ToPhoneNumber" v-model="value.toPhoneNumber"/>
          </div>
          <div class="grey--text ml-4" v-else>
